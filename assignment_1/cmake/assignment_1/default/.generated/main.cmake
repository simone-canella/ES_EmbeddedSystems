...
<<<<<<< HEAD:assignments/assignment_1/cmake/assignment_1/default/.generated/main.cmake
add_executable(assignment_1_default_image_dA3Hr10t ${assignment_1_default_library_list})

set_target_properties(assignment_1_default_image_dA3Hr10t PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${assignment_1_default_output_dir}")
target_link_libraries(assignment_1_default_image_dA3Hr10t PRIVATE ${assignment_1_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
assignment_1_default_link_rule( assignment_1_default_image_dA3Hr10t)

# Call bin2hex function from the rule file
assignment_1_default_bin2hex_rule(assignment_1_default_image_dA3Hr10t)
=======
add_executable(assignment_1_default_image_a_s9q9zO ${assignment_1_default_library_list})

set_target_properties(assignment_1_default_image_a_s9q9zO PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${assignment_1_default_output_dir}")
target_link_libraries(assignment_1_default_image_a_s9q9zO PRIVATE ${assignment_1_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
assignment_1_default_link_rule( assignment_1_default_image_a_s9q9zO)

# Call bin2hex function from the rule file
assignment_1_default_bin2hex_rule(assignment_1_default_image_a_s9q9zO)
>>>>>>> c176c6882c7d4871c8768f8dacbe6e5a0ff4a087:assignments/exam/17_assignment1/cmake/assignment_1/default/.generated/main.cmake
