...
add_executable(assignment_2_default_image_GNqKI2pC ${assignment_2_default_library_list})

set_target_properties(assignment_2_default_image_GNqKI2pC PROPERTIES
    OUTPUT_NAME "default-production"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${assignment_2_default_output_dir}")
target_link_libraries(assignment_2_default_image_GNqKI2pC PRIVATE ${assignment_2_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
assignment_2_default_link_rule( assignment_2_default_image_GNqKI2pC)

# Call bin2hex function from the rule file
assignment_2_default_bin2hex_rule(assignment_2_default_image_GNqKI2pC)
