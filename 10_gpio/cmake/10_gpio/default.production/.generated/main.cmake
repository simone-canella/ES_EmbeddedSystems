...
add_executable(10_gpio_default_image_jcUUD4LY ${10_gpio_default_library_list})

set_target_properties(10_gpio_default_image_jcUUD4LY PROPERTIES
    OUTPUT_NAME "default-production"
    SUFFIX ".elf"
    RUNTIME_OUTPUT_DIRECTORY "${10_gpio_default_output_dir}")
target_link_libraries(10_gpio_default_image_jcUUD4LY PRIVATE ${10_gpio_default_default_XC16_FILE_TYPE_link})

# Add the link options from the rule file.
A_10_gpio_default_link_rule( 10_gpio_default_image_jcUUD4LY)

# Call bin2hex function from the rule file
A_10_gpio_default_bin2hex_rule(10_gpio_default_image_jcUUD4LY)
